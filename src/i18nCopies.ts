...
export const en: SourceCopy = {
  ...
  attachFailed: 'Could not attach the selected files',
  attachmentTooLarge: 'File is too large to attach: {name}',
  toolDone: 'Done',
  toolRunning: 'Running',
  toolFailed: 'Failed',
  toolInput: 'IN',
...
export const zh: SourceCopy = {
  ...
  chooseFiles: '选择文件',
  attachFailed: '无法添加所选文件',
  attachmentTooLarge: '文件过大，无法添加：{name}',
  toolDone: '完成',
  toolRunning: '运行中',
  toolFailed: '失败',
  toolInput: '输入',
